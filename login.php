...
<head>
	<title>3 Season Thai - Login</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-t-55 m-b-35" data-validate="Enter username">
						<input ng-model="username" class="input100" type="text" name="username">
						<span class="focus-input100" data-placeholder="Username"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
						<input ng-model="password" class="input100" type="password" name="pass">
